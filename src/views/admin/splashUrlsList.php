...
<table class='grid'>
	...
	<tr class="<?php echo (($i%2)?"odd":"even") ?>">
		...
		<td><?php echo '<a href="'.ROOT_URL.'mouf/ajaxinstance/?name='.plainstring_to_htmlprotected($splashUrl->controllerInstanceName).'&selfedit='.$this->selfedit.'">'.$splashUrl->controllerInstanceName.'</a>'; ?></td>
